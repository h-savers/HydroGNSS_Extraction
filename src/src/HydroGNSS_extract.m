...
time=[]; SPLAT=[]; SPLON=[];  THETA=[] ;  Constellation = strings(numOfSP,1); TrailingEdgeWidth=[] ; SPAzimuthAngleDeg_Orbit=[] ;DoY=[] ; SoD=[] ;  
...
QualityControlFlags_L1_RHCP = NaN(numOfSP,1) ; QualityControlFlags_L1_LHCP = NaN(numOfSP,1); QualityControlFlags_L5_RHCP = NaN(numOfSP,1) ; QualityControlFlags_L5_LHCP = NaN(numOfSP,1); QualityControlFlags_E1_RHCP = NaN(numOfSP,1) ; QualityControlFlags_E1_LHCP = NaN(numOfSP,1); QualityControlFlags_E5_RHCP = NaN(numOfSP,1) ; QualityControlFlags_E5_LHCP = NaN(numOfSP,1);
...
elseif isstring(t_track) || ischar(t_track)
 ...
 %           TrailingEdgeWidth=computeTE(DDM,Power_threshold);  
 % delay_vector
...
if isfield(ReflectionCoefficientAtSP(kk),'QC_pass_flag')&&~ismissing(ReflectionCoefficientAtSP(kk).QC_pass_flag),QC_pass_flag(intrack:fintrack)=ReflectionCoefficientAtSP(kk).QC_pass_flag;end;
  ...
  % 
    ...
    %QualityControlFlag lines
     if ismissing(ReflectionCoefficientAtSP(kk).QualityControlFlags_L1_LHCP)==0 , QualityControlFlags_L1_LHCP(intrack:fintrack)=ReflectionCoefficientAtSP(kk).QualityControlFlags_L1_LHCP ; end
     if ismissing(ReflectionCoefficientAtSP(kk).QualityControlFlags_L1_RHCP)==0 , QualityControlFlags_L1_RHCP(intrack:fintrack)=ReflectionCoefficientAtSP(kk).QualityControlFlags_L1_RHCP ; end

     if ismissing(ReflectionCoefficientAtSP(kk).QualityControlFlags_L5_LHCP)==0 , QualityControlFlags_L5_LHCP(intrack:fintrack)=ReflectionCoefficientAtSP(kk).QualityControlFlags_L5_LHCP ; end
     if ismissing(ReflectionCoefficientAtSP(kk).QualityControlFlags_L5_RHCP)==0 , QualityControlFlags_L5_RHCP(intrack:fintrack)=ReflectionCoefficientAtSP(kk).QualityControlFlags_L5_RHCP ; end
...
if ismissing(ReflectionCoefficientAtSP(kk).PowerAnalog_W_L5_RHCP)==0 , PowerAnalog_W_L5_RHCP(intrack:fintrack)=ReflectionCoefficientAtSP(kk).PowerAnalog_W_L5_RHCP ; end
   ...
   %EIRP lines
    ...
    if ismissing(ReflectionCoefficientAtSP(kk).QualityControlFlags_E1_LHCP)==0 , QualityControlFlags_E1_LHCP(intrack:fintrack)=ReflectionCoefficientAtSP(kk).QualityControlFlags_E1_LHCP ; end
    if ismissing(ReflectionCoefficientAtSP(kk).QualityControlFlags_E1_RHCP)==0 , QualityControlFlags_E1_RHCP(intrack:fintrack)=ReflectionCoefficientAtSP(kk).QualityControlFlags_E1_RHCP ; end

    if ismissing(ReflectionCoefficientAtSP(kk).QualityControlFlags_E5_LHCP)==0 , QualityControlFlags_E5_LHCP(intrack:fintrack)=ReflectionCoefficientAtSP(kk).QualityControlFlags_E5_LHCP ; end
    if ismissing(ReflectionCoefficientAtSP(kk).QualityControlFlags_E5_RHCP)==0 , QualityControlFlags_E5_RHCP(intrack:fintrack)=ReflectionCoefficientAtSP(kk).QualityControlFlags_E5_RHCP ; end
...
save([char(DataOutputRootPath) '\' Nameout], 'SPLAT', 'SPLON', 'IncidenceAngleDeg','SPAzimuthAngleDeg_Orbit', 'DoY',  'SoD', 'time',...
    ...
    'QualityControlFlags_L1_RHCP','QualityControlFlags_L1_LHCP','QualityControlFlags_L5_RHCP','QualityControlFlags_L5_LHCP','QualityControlFlags_E1_RHCP','QualityControlFlags_E1_LHCP','QualityControlFlags_E5_RHCP','QualityControlFlags_E5_LHCP', ...
    ...
    'pseudo_random_noise', 'Year', 'TrailingEdgeWidth', 'Constellation', ...
